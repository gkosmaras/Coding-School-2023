...
namespace Session_I
{
    public class Extra
    {
        ...
        public virtual void LogEventMessage(Guid requestID, string requestIn, string requestOut, Picker action, DateTime timStamp) { }
        public virtual void LogEventError(Guid requestID, string requestIn, Picker action, DateTime timStamp) { }
