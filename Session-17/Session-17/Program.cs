...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        for (int i = 0; i < qList.Headers().Count ; i++)
        {
            ...
            Console.WriteLine(i.ToString() + ") " + qList.Headers()[i] + Environment.NewLine, Console.ForegroundColor);
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine(aList.Headers()[i] + Environment.NewLine, Console.ForegroundColor);
        }
        Console.ReadLine();
    }
}
